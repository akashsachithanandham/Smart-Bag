...
if ( mfrc522.uid.uidByte[0] == 0x17 && 
     mfrc522.uid.uidByte[1] == 0x2d &&
     mfrc522.uid.uidByte[2] == 0x76 &&
     mfrc522.uid.uidByte[3] == 0xa1 ) {
     // turn your LED on
    Serial.println("Scanned");
    a = 1 - a;
    if (a == 1) Serial.println("Book Inside");
    if (a == 0) Serial.println("Book Taken Out");
    Firebase.setFloat("Maths", a);
    delay(5000);
}
